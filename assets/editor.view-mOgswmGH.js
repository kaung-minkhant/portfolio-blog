...
import { c as commonjsGlobal, g as getDefaultExportFromCjs, a as getAugmentedNamespace } from './_commonjsHelpers-9Q-OoQuc.js';
...
const {styled: styled$3} = await importShared('styled-components');

const EditorPane = styled$3.div`
  flex: 1;
  display: flex;
...
const QuillEditor = /*@__PURE__*/getDefaultExportFromCjs(lib);

const {styled: styled$2} = await importShared('styled-components');
const Editor = styled$2.div`
  width: 100%;
  min-height: 90%;
  display: flex;
  flex-direction: column;
  ...
  gap: 10px;
`;
const BlogMetaDataContainer = styled$2.div`
  ...
  gap: 10px;
`;
const BlogTitle = styled$2.div`
  display: flex;
  align-items: center;
  gap: 10px;
  width: 100%;
`;
const BlogTitleInput = styled$2.input`
  flex: 1;
...
`;
const BlogMetaDataLabel = styled$2.label`
  font-weight: 600;
  font-size: 20px;
`;
const BlogDescription = styled$2.div`
  display: flex;
  align-items: flex-start;
  width: 100%;
  gap: 10px;
`;
const BlogDescriptionInput = styled$2.textarea`
  flex: 1;
  outline: none;
  padding: 5px 10px;
  border-radius: 6px;
...
`;
const QuillContainer = styled$2(QuillEditor)`
  width: 100%;
  flex: 1;
  display: flex;
  flex-direction: column;
  position: relative;
`;
const QuillWrapper = styled$2.div`
  width: 100%;
  flex: 1;
  display: flex;
  flex-direction: column;
...
const QuillToolBar = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "toolbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ql-formats", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "ql-header", defaultValue: "3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Heading" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Subheading" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "Normal" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-bold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-italic" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-underline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-strike" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-list", value: "ordered" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-list", value: "bullet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-indent", value: "-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-indent", value: "+1" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-script", value: "super" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-script", value: "sub" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-blockquote" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: "ql-align" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: "ql-color" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: "ql-background" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-link" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-image" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ql-formats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-code-block" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ql-clean" })
    ] })
  ] });
};
...
var BlotFormatterExports = requireBlotFormatter();
const BlotFormatter = /*@__PURE__*/getDefaultExportFromCjs(BlotFormatterExports);
...
const {useMemo,useCallback} = await importShared('react');
const Size = lib.Quill.import("formats/size");
lib.Quill.register({
  "modules/blotFormatter": BlotFormatter,
  "modules/imageDropAndPaste": ImageDropAndPaste
});
Size.whitelist = ["extra-small", "small", "medium", "large"];
lib.Quill.register(Size, true);
const Font = lib.Quill.import("formats/font");
Font.whitelist = [
  "arial",
  "comic-sans",
  "courier-new",
...
const EditorComponent = () => {
  const [editorField, setEditorField] = useContext$1(EditorFieldContext);
  const quill = useRef();
  const { modules, formats } = useEditorHook(quill);
  useEffect(() => {
    console.log({ editorField });
  }, [editorField]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Editor, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(BlogMetaDataContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(BlogTitle, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BlogMetaDataLabel, { children: "Title" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BlogTitleInput, { type: "text", placeholder: "My Blog Title" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(BlogDescription, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BlogMetaDataLabel, { children: "Description" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BlogDescriptionInput, { rows: 5, placeholder: "Description will be used as abstract or Summary" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(QuillWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(QuillToolBar, {}),
...
const {styled: styled$1} = await importShared('styled-components');
...
const ButtonGroup = styled$1("div").withConfig({
...
const Button = styled$1("button").withConfig({
  shouldForwardProp: (prop) => !["backgroundColor", "padding", "fontSize"].includes(prop)
})`
...
const PreviewComponent = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Preview, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewTitle, { children: "Preview" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuillEditor,
      {
        value: editorField,
        readOnly: true,
...
const {createContext,useState} = await importShared('react');
const EditorFieldContext = createContext();
const EditorView = () => {
  const [editorField, setEditorField] = useState("");
  const [isPreviewing, setIsPreviewing] = useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(EditorFieldContext.Provider, { value: [editorField, setEditorField], children: /* @__PURE__ */ jsxRuntimeExports.jsxs(EditorPane, { children: [
    isPreviewing ? /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewComponent, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(EditorComponent, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ButtonGroup, { gap: "15", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { backgroundColor: backgroundColors.primary, children: "Save As Draft" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { backgroundColor: backgroundColors.primary, children: "Save" }),
      isPreviewing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => {
        setIsPreviewing(false);
      }, backgroundColor: backgroundColors.secondary, children: "Edit" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => {
        setIsPreviewing(true);
      }, backgroundColor: backgroundColors.secondary, children: "Preview" })
    ] })
  ] }) });
};

export { EditorView as E };
