...
var Ve = new Re(), Fe = xe(), Me = o.createContext({ shouldForwardProp: void 0, styleSheet: Ve, stylis: Fe }), $e = Me.Consumer, ze = o.createContext(void 0);
function Be() {
  return c(Me);
}
function Le(e2) {
  var t2 = s(e2.stylisPlugins), n2 = t2[0], r2 = t2[1], c2 = Be().styleSheet, l2 = i(function() {
    var t3 = c2;
  ...
  return o.createElement(Me.Provider, { value: d2 }, o.createElement(ze.Provider, { value: u2 }, e2.children));
}
var Ge = function() {
  function e2(e3, t2) {
    var n2 = this;
...
}(), Ke = o.createContext(void 0), Qe = Ke.Consumer;
function et() {
  var e2 = c(Ke);
  if (!e2)
    throw he(18);
...
function tt(e2) {
  var n2 = o.useContext(Ke), r2 = i(function() {
  ...
  return e2.children ? o.createElement(Ke.Provider, { value: r2 }, e2.children) : null;
}
var nt = {};
...
function dt(n2) {
  ...
  var i2 = at.apply(void 0, __spreadArray([n2], r2, false)), a2 = "sc-global-".concat(z(JSON.stringify(i2))), c2 = new pt(i2, a2);
  var l2 = function(e2) {
    var t2 = Be(), n3 = o.useContext(Ke), r3 = o.useRef(t2.styleSheet.allocateGSInstance(a2)).current;
...
function ft(e2) {
  var n2 = o.forwardRef(function(n3, r2) {
    var s2 = I(n3, o.useContext(Ke), e2.defaultProps);
...
var mt = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n2 = Pe(), o2 = ae([n2 && 'nonce="'.concat(n2, '"'), "".concat(f, '="true"'), "".concat(y, '="').concat(v, '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw he(2);
      var r2 = ((n2 = {})[f] = "", n2[y] = v, n2.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n2), s2 = Pe();
  ...
  return e2.prototype.collectStyles = function(e3) {
    if (this.sealed)
      throw he(2);
    return o.createElement(Le, { sheet: this.instance }, e3);
